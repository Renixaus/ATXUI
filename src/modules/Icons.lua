...
local IconModule =
	cloneref(game:GetService("ReplicatedStorage"):WaitForChild("GetIcons", 99999):InvokeServer())
...
function IconModule.Image(IconConfig)
	local Icon = {
		...
		Colors = IconConfig.Colors
			or { (IconModule.IconThemeTag or Color3.new(1, 1, 1)), Color3.new(1, 1, 1) },
