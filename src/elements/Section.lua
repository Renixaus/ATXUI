...
function Element:New(Config)
	...
	local function createTitle(Text, Type)
		return New("TextLabel", {
			...
			FontFace = Font.new(
				Creator.Font,
				Type == "Title" and Section.FontWeight or Section.DescFontWeight
			),
	...
	local Main = Creator.NewRoundFrame(Config.Window.ElementConfig.UICorner, "Squircle", {
		...
		New("TextButton", {
			Size = UDim2.new(
				...
				0,
				0,
				Section.Expandable and 0 or (not DescFrame and Section.HeaderSize or 0)
			),
			BackgroundTransparency = 1,
				...
				Tween(Main, 0.35, {
					Size = UDim2.new(
						...
						Main.Top.AbsoluteSize.Y / Config.UIScale
							+ (Main.Content.AbsoluteSize.Y / Config.UIScale)
					),
