...
return function(Config)
	...
	local function CreateText(Title, Type)
		...
		return New("TextLabel", {
			...
			FontFace = Font.new(
				Creator.Font,
				Type == "Desc" and Enum.FontWeight.Medium or Enum.FontWeight.SemiBold
			),
		})
	end
	...
	Element.UIElements.Container = New("Frame", {
		...
		New("Frame", {
			...
			New("UIListLayout", {
				...
				VerticalAlignment = Config.Window.NewElements
						and (Element.Justify == "Between" and "Top" or "Center")
					or "Center",
			...
			New("Frame", {
				...
				Size = UDim2.new(
					...
					Element.Justify == "Between"
							and (ImageFrame and -IconOffset - Element.UIPadding or -IconOffset)
						or 0,
					1,
					0
				),
	...
	function Element:Lock(newtitle)
		...
		Locked.ImageTransparency = 1
		Locked.Active = true
		Locked.Visible = true
		Tween(Locked, 0.2, { ImageTransparency = 0.25 }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
	end

	function Element:Unlock()
		CanHover = true
		Locked.Active = false
		Tween(Locked, 0.15, { ImageTransparency = 1 }, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
